  ...
  /**
  	1	Dentro del mismo servidor de bases de datos, conéctate al esquema
    classicmodels.
  */
    USE classicmodels;
  ...
  */
  ...
  /**
  	3	Dentro de la tabla employees, obtén el apellido, nombre y puesto de todos
    los empleados.
  */
    SELECT
  ...
  */
  ...
  /**
  	6	Dentro de la tabla employees, obtén el apellido, nombre, puesto y código
    de oficina de todos los empleados que tengan el puesto Sales Rep y código de
    oficina 1.
  */
    SELECT
  ...
  /**
  	7	Dentro de la tabla employees, obtén el apellido, nombre, puesto y código
    de oficina de todos los empleados que tengan el puesto Sales Rep o código de
    oficina 1.
  */
    SELECT
      lastName, firstName, jobTitle, officeCode
  ...
  /**
  	8	Dentro de la tabla employees, obtén el apellido, nombre y código de
    oficina de todos los empleados que tengan código de oficina 1, 2 o 3.
  */
    SELECT
  ...
  /**
  	9	Dentro de la tabla employees, obten el apellido, nombre y puesto de todos
    los empleados que tengan un puesto distinto a Sales Rep.
  */
    SELECT
      lastName, firstName, jobTitle
    FROM
  ...
  /**
  	10	Dentro de la tabla employees, obtén el apellido, nombre y código de
  ...
  */
  ...
  /**
    ...
    oficina de todos los empleados cuyo código de oficina sea menor o igual 4.
  */
    SELECT
      lastName, firstName, officeCode
    FROM
  ...
  */
  ...
  /**
  	13	Dentro de la tabla customers, obtén el nombre, país, estado y límite de
    crédito de todos los clientes cuyo país sea, USA, cuyo estado sea CA y cuyo
    límite de crédito sea mayor a 100000.
  */
    SELECT
  ...
  */
    ...
    FROM
      customers
    WHERE
      country IN ('USA', 'France') AND creditLimit > 100000;
  ...
  */
  ...
  /**
    ...
    estado y fecha de envío de todas las órdenes con el número 10165, 10287 o
    10310.
  */
    SELECT
  ...
  */
  ...
  /**
    ...
    cliente y el límite de crédito de los cinco clientes con el límite de
    crédito más bajo diferente de 0.
  */
    SELECT
      customerNumber, customerName, creditLimit
    FROM
