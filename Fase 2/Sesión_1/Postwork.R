...
# (FTHG) y los goles anotados por los equipos que jugaron como visitante (FTAG); guárdalos en vectores separados
v.FTHG <- sp1$FTHG
v.FTAG <- sp1$FTAG
...
########### que el mayor empate es 4-4 y su frecuencia fue 1
