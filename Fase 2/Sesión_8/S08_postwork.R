...
m1 <- lm(ln_als ~ numpeho + edadjef + añosedu) #funcion lm lineal model
summary(m1)
...
# Según este modelo de regresión lineal, el número de personas en el hogar y los años de educación, determinan el gasto en alimentos saludables
